...
As you defeat enemies and raid caches, you can potentially find salvageable weapons, systems, and ammo, or scrap to be used as currency for upgrades.  You can swap out the weapons and systems that you have, and anything you've picked up that you aren't using is stored on the transport.
